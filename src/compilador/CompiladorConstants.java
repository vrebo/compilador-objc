...
public interface CompiladorConstants {
  ...
  int IMPORTACION = 57;
  /** RegularExpression Id. */
  int DELIMITADOR_INSTRUCCION = 58;
  /** RegularExpression Id. */
  int DOS_PUNTOS = 59;
  /** RegularExpression Id. */
  int COMA = 60;
  /** RegularExpression Id. */
  int PARENTESIS_APERTURA = 61;
  /** RegularExpression Id. */
  int PARENTESIS_CERRADURA = 62;
  /** RegularExpression Id. */
  int LLAVE_APERTURA = 63;
  /** RegularExpression Id. */
  int LLAVE_CERRADURA = 64;
  /** RegularExpression Id. */
  int CORCHETE_APERTURA = 65;
  /** RegularExpression Id. */
  int CORCHETE_CERRADURA = 66;
  /** RegularExpression Id. */
  int COMILLA_DOBLE = 67;
  /** RegularExpression Id. */
  int ID = 68;
  /** RegularExpression Id. */
  int LETRA = 69;
